...
<form  action="{{url('/goods/update/'.$res->g_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" value="{{$res->g_name}}" name="g_name" id="firstname" 
				   >
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" value="{{$res->g_order}}" name="g_order" id="firstname" 
				  >
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" value="{{$res->g_price}}" name="g_price" id="firstname" 
				   >
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" value="{{$res->g_num}}" name="g_num" id="firstname" 
				   >
...
<div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
         <textarea name="g_desc" cols="30" rows="10">{{$res->g_desc}}</textarea>
	...
	<!-- <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="file" name="g_imgs" class="form-control">
		</div>
	</div> -->
    <div class="form-group">
